...
function Header() {
  ...
  const handleShowHeader = () => {
    ...
    // if (window.scrollY > lastScroll && showHeader) {
    //   setShowHeader(false);
    // }
    // if (window.scrollY <= lastScroll && !showHeader) {
    //   setShowHeader(true);
    ...
    <>
      ...
      <div className="mobileHeader">
          ...
          <Row>
            ...
            <Col>
              <div className="menu-right">
                ...
                <div></div>
                <div onClick={() => toggleMenuBar()} className="menu-btn">
        ...
        <MobileMenuBar
          ...
          hasToken={cookie.get('token') ? true : false}
          username={userLocalStorage ? userLocalStorage.name : 'user'}
          toggleLoginForm={toggleLoginForm}
          toggleRegisterForm={toggleRegisterForm}
